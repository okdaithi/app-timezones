 ...
 * Nothing here reads the device's default zone. The device zone is irrelevant to this widget.
 */
...
internal fun dayLabel(z: ZonedDateTime) = "${weekday(z)} ${z.dayOfMonth} ${MONTHS[z.monthValue - 1]}"
...
internal fun hm(minutes: Int): String {
